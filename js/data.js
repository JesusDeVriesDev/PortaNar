...
export const PIEZAS = [
  {
    id: 0, archivo: "porta1", nombre: "Volcan Galeras", lugar: "El Guardian de Pasto",
    accent: "var(--c0)",
    material: "Cartón reciclado teñido con rojo y carbón para el dibujo",
    colorBase: "Silueta del volcán en negro en el rojo de la remolacha.",
    tecnica: "Silueta pintada a pincel sobre un fondo rojizo",
    ...
    mensaje: "El que nos protege",
    peso: "12 g", diametro: "≈ 11 cm", bio: "4–8 semanas",
  ...
  {
    id: 1, archivo: "porta2", nombre: "Laguna de la Cocha", lugar: "Laguna de la Cocha",
    accent: "var(--c1)",
    material: "Cartón reciclado teñido con azul",
    colorBase: "Azul intenso y un paisaje magnifico.",
    tecnica: "Cuy tallado a pincel fino sobre la cocha en una lancha en la cocha",
    ...
    mensaje: "Laguna de la Cocha",
    peso: "13 g", diametro: "≈ 12 cm", bio: "4–8 semanas",
    final: "100% cartón y colorantes vegetales: puede compostarse en casa o enterrarse en tierra húmeda. En 4 a 8 semanas se descompone por completo."
  },
  {
    id: 2, archivo: "porta3", nombre: "Carnaval de Negros y Blancos", lugar: "Carnaval de Negros y Blancos",
    accent: "var(--c2)",
    material: "Cartón reciclado teñido con negro de carbón",
    colorBase: "Negro carbón, estampado con una pintura hecha a mano con textura.",
    tecnica: "Estampado a mano de dos caras",
    ...
    mensaje: "Patrimonio de la humanidad",
    peso: "14 g", diametro: "≈ 11 cm", bio: "4–8 semanas",
    final: "100% cartón y colorantes vegetales: puede compostarse en casa o enterrarse en tierra húmeda. En 4 a 8 semanas se descompone por completo."
  },
  {
    id: 3, archivo: "porta4", nombre: "Sombrero de Paja", lugar: "Sombrero de Paja Toquilla",
    accent: "var(--c3)",
    material: "Cartón reciclado tellido con el amarillo de la curcuma.",
    colorBase: "Amarillo natural de la curcuma con líneas entrecruzadas en megrp, imitando un tejido.",
    ...
    mensaje: "Moda y tradición",
    peso: "12 g", diametro: "≈ 12 cm", bio: "4–8 semanas",
    final: "100% cartón y colorantes vegetales: puede compostarse en casa o enterrarse en tierra húmeda. En 4 a 8 semanas se descompone por completo."
  },
  {
    id: 4, archivo: "porta5", nombre: "Orquídeas nariñenses", lugar: "Orquídeas de Nariño",
    accent: "var(--c4)",
    material: "Cartón reciclado teñido con remolacha diluida",
    colorBase: "Rosa suave con la silueta de una orquídea en negro concentrado.",
    ...
    mensaje: "Flores bellas de la región",
    peso: "14 g", diametro: "≈ 12 cm", bio: "4–8 semanas",
    final: "100% cartón y colorantes vegetales: puede compostarse en casa o enterrarse en tierra húmeda. En 4 a 8 semanas se descompone por completo."
  },
  {
    id: 5, archivo: "porta6", nombre: "El Cuy", lugar: "Comida tradicional",
    accent: "var(--c5)",
    material: "Cartón reciclado teñido con zanahoria.",
    colorBase: "Naranja tostado con la silueta de un cuy asado en el centro y un borde hecho con guasca.",
    tecnica: "Silueta pintada a pincel imitando el querido cuy.",
    ...
    mensaje: "Tradición culinaria",
    peso: "18 g", diametro: "≈ 12 cm", bio: "4–8 semanas",
    final: "100% cartón y colorantes vegetales: puede compostarse en casa o enterrarse en tierra húmeda. En 4 a 8 semanas se descompone por completo."
  }
];
